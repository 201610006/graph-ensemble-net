...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1000):
        ...
        self.mm_mrg3 = MRGblock(self.layer3_c + self.layer3_c, self.layer3_c)
        self.conv_u1 = Conv_Bn_Activation(self.layer3_c, self.layer4_c, kernel_size=3, stride=2, activation='relu')

        self.conv_zp2 = nn.Conv2d(self.layer3_c, self.layer2_c, kernel_size=1, padding=0)
        self.mm_mrg2 = MRGblock(self.layer2_c + self.layer2_c, self.layer2_c)
        self.conv_u2 = Conv_Bn_Activation(self.layer2_c, 2 * self.layer2_c, kernel_size=3, stride=2, activation='relu')
        self.conv_u3 = Conv_Bn_Activation(2 * self.layer2_c, 4 * self.layer2_c, kernel_size=3, stride=2, activation='relu')
...
#####################向上cat###########################
        ...
        m3 = torch.cat([self.upsample(self.conv_zp1(m4)), out3], dim=1)
        m3 = self.mm_mrg3(m3)
        ...
        m2 = torch.cat([self.upsample(self.conv_zp2(m3)), out2], dim=1)
        m2 = self.mm_mrg2(m2)
