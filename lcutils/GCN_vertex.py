...
class gcn_backbone(nn.Module):
    def __init__(self, drop_path_rate=0.0, num_knn=9, n_filters = 512, blocks=4, **kwargs):
        ...
        self.backbone = Seq(*[Seq(Grapher(self.n_filters, num_knn[i], 1, self.conv, self.act, self.norm,
                                     self.bias, self.use_dilation, self.epsilon, 1, drop_path=dpr[i]),
