...
from Resnet_gcn_twin import GEEL_Net
import numpy as np
import torch
import glob
import json
...
if __name__ == '__main__':
    ...
    #pth = 'output/train/20231018-095816-ds_twin_l3c2-416/model_best.pth.tar'
    #pth = 'output/train/20231020-095034-ds_twin_l3c2-416/model_best.pth.tar'
    pth = 'output/train/20231107-130623-ds_twin_gamma-416/model_best.pth.tar'
    #pth = 'output/train/20231027-103210-ds_twin_l3c2-416/checkpoint-113.pth.tar'
    ...
    for imgfile in glob.glob(imgpth+'/*'):
        ...
        for imgs in glob.glob(imgfile+'/*'):
            ...
            img = load_image(imgs)
            out, (class1, score1), (class2, score2), (class3, score3) = model(img.to(device))

            predicted_index = torch.argmax(out)
            cf = (score1[0] + score2[0] + score3[0]) / 3
