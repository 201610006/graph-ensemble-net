...
class ViT(nn.Module):
    def __init__(self, *, image_size=416, patch_size=32, num_classes=10, dim=768, depth=4, heads=9, mlp_dim=1024, pool='cls', channels=3, dim_head=64, dropout=0.1, emb_dropout=0.1):
        super().__init__()
